(function (global) {
  ...
  const API = {
    sanitize,
    htmlEscape,
    htmlEscapeWithBreaks,
    gmailStyleFromOptions,
    destinationStyleFromOptions,
    styleAttributeFromOptions,
    buildGmailHtml,
    docBlocksAsGmailLines,
    buildGmailLineDiv,
    buildGmailListHtml,
